...
type NotFound struct {
	Errors *NotFoundErrors `json:"errors,omitempty"`
...
// SetErrors gets a reference to the given NotFoundErrors and assigns it to the Errors field.
