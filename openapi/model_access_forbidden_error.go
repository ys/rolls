...
// AccessForbiddenError struct for AccessForbiddenError
...
func (o AccessForbiddenError) MarshalJSON() ([]byte, error) {
...
type NullableAccessForbiddenError struct {
	value *AccessForbiddenError
	isSet bool
}

func (v NullableAccessForbiddenError) Get() *AccessForbiddenError {
	return v.value
}

func (v *NullableAccessForbiddenError) Set(val *AccessForbiddenError) {
	v.value = val
	v.isSet = true
}

func (v NullableAccessForbiddenError) IsSet() bool {
	return v.isSet
}

func (v *NullableAccessForbiddenError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccessForbiddenError(val *AccessForbiddenError) *NullableAccessForbiddenError {
	return &NullableAccessForbiddenError{value: val, isSet: true}
}

func (v NullableAccessForbiddenError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccessForbiddenError) UnmarshalJSON(src []byte) error {
	v.isSet = true
