...
------------ | ------------- | ------------- | -------------
**Errors** | Pointer to [**NotFoundErrors**](NotFoundErrors.md) |  | [optional] 
...
`func (o *NotFound) GetErrors() NotFoundErrors`

GetErrors returns the Errors field if non-nil, zero value otherwise.

### GetErrorsOk

`func (o *NotFound) GetErrorsOk() (*NotFoundErrors, bool)`
...
`func (o *NotFound) SetErrors(v NotFoundErrors)`
